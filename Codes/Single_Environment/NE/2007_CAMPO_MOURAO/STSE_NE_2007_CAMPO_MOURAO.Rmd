---
title: "Single-Trait Single-Environment Analysis - NE 2007_CAMPO_MOURAO"
output: pdf_document
...
Select the BLUEs from trait NE and environment 2007_CAMPO_MOURAO
...
for(fold in n_folds){
  ...
  print(paste('Model STSE.NE_2007_CM', fold))

  STSE.NE_2007_CM = MCMCglmm(NE_BLUE ~ 1,
                    random= ~ H,
  ...
  blups = colMeans(STSE.NE_2007_CM$Sol)
...
save.image("2007_CAMPO_MOURAO_NE_CV.RData")
```
