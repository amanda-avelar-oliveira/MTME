---
title: "Single-Trait Single-Environment Analysis - GY 2006_CAMPO_MOURAO"
output: pdf_document
...
Select the BLUEs from trait GY and environment 2006_CAMPO_MOURAO
...
for(fold in n_folds){
  ...
  print(paste('Model STSE.GY_2006_CM', fold))

  STSE.GY_2006_CM = MCMCglmm(GY_BLUE ~ 1,
                    random= ~ H,
  ...
  blups = colMeans(STSE.GY_2006_CM$Sol)
...
save.image("2006_CAMPO_MOURAO_GY_CV.RData")
```
