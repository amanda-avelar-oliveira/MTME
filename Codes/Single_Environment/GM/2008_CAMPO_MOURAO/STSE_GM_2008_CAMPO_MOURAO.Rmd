---
title: "Single-Trait Single-Environment Analysis - GM 2008_CAMPO_MOURAO"
output: pdf_document
...
Select the BLUEs from trait GM and environment 2008_CAMPO_MOURAO
...
for(fold in n_folds){
  ...
  print(paste('Model STSE.GM_2008_CM', fold))

  STSE.GM_2008_CM = MCMCglmm(GM_BLUE ~ 1,
                    random= ~ H,
  ...
  blups = colMeans(STSE.GM_2008_CM$Sol)
...
save.image("2008_CAMPO_MOURAO_GM_CV.RData")
```
