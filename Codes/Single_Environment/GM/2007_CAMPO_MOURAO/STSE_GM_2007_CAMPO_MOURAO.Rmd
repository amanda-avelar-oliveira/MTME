---
title: "Single-Trait Single-Environment Analysis - GM 2007_CAMPO_MOURAO"
output: pdf_document
...
Select the BLUEs from trait GM and environment 2007_CAMPO_MOURAO
...
for(fold in n_folds){
  ...
  print(paste('Model STSE.GM_2007_CM', fold))

  STSE.GM_2007_CM = MCMCglmm(GM_BLUE ~ 1,
                    random= ~ H,
  ...
  blups = colMeans(STSE.GM_2007_CM$Sol)
...
save.image("2007_CAMPO_MOURAO_GM_CV.RData")
```
