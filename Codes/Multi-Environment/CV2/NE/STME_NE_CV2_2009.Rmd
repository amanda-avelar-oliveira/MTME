---
title: "Single-Trait Multi-Environment Analysis - NE 2009 CV2"
output: pdf_document
...
tst <- which(BLUEs_NE$Env == "2009_CAMPO_MOURAO")
yteste <- BLUEs_NE[tst,]
yteste2 <- yteste
yteste2$NE_BLUE <- NA
...
STME.NE.CV2.2009 = MCMCglmm(NE_BLUE ~ -1 + Env,
                   random= ~us(Env):H,
...
blups = colMeans(STME.NE.CV2.2009$Sol)
...
save.image("STME_NE_CV2_2009.RData")  
```
