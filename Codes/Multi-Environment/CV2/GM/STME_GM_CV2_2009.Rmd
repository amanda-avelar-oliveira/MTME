---
title: "Single-Trait Multi-Environment Analysis - GM 2009 CV2"
output: pdf_document
...
tst <- which(BLUEs_GM$Env == "2009_CAMPO_MOURAO")
yteste <- BLUEs_GM[tst,]
yteste2 <- yteste
yteste2$GM_BLUE <- NA
...
STME.GM.CV2.2009 = MCMCglmm(GM_BLUE ~ -1 + Env,
                   random= ~us(Env):H,
...
blups = colMeans(STME.GM.CV2.2009$Sol)
...
acc_mcmcglmm <- cor(final_gm[,4],final_gm[,5])


save.image("STME_GM_CV2_2009.RData")  
```
