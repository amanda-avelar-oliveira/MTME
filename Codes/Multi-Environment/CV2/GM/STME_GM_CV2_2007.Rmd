---
title: "Single-Trait Multi-Environment Analysis - GM 2007 CV2"
output: pdf_document
...
tst <- which(BLUEs_GM$Env == "2007_CAMPO_MOURAO")
yteste <- BLUEs_GM[tst,]
yteste2 <- yteste
yteste2$GM_BLUE <- NA
...
STME.GM.CV2.2007 = MCMCglmm(GM_BLUE ~ -1 + Env,
                   random= ~us(Env):H,
...
blups = colMeans(STME.GM.CV2.2007$Sol)
...
save.image("STME_GM_CV2_2007.RData")  
```
