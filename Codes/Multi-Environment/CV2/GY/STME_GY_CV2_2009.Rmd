---
title: "Single-Trait Multi-Environment Analysis - GY 2009 CV2"
output: pdf_document
...
tst <- which(BLUEs_GY$Env == "2009_CAMPO_MOURAO")
yteste <- BLUEs_GY[tst,]
yteste2 <- yteste
yteste2$GY_BLUE <- NA
...
STME.GY.CV2.2009 = MCMCglmm(GY_BLUE ~ -1 + Env,
                   random= ~us(Env):H,
...
blups = colMeans(STME.GY.CV2.2009$Sol)
...
save.image("STME_GY_CV2_2009.RData")  
```
