---
title: "Single-Trait Multi-Environment Analysis - GY 2006 CV2"
output: pdf_document
...
tst <- which(BLUEs_GY$Env == "2006_CAMPO_MOURAO")
yteste <- BLUEs_GY[tst,]
yteste2 <- yteste
yteste2$GY_BLUE <- NA
...
STME.GY.CV2.2006 = MCMCglmm(GY_BLUE ~ -1 + Env,
                   random= ~us(Env):H,
...
blups = colMeans(STME.GY.CV2.2006$Sol)
...
save.image("STME_GY_CV2_2006.RData")  
```
