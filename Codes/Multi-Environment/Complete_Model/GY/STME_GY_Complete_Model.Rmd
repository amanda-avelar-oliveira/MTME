---
title: "Single-Trait Multi-Environment Analysis - GY Complete Model"
output: pdf_document
...
```{r, eval=FALSE, message=FALSE}
complete.model.ME.GY = MCMCglmm(GY_BLUE ~ -1 + Env,
                               random= ~us(Env):H,
...
summary(complete.model.ME.GY) 
dim(complete.model.ME.GY$VCV) 

save.image("complete.model.ME.GY.RData")
